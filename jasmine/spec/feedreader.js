...
$(function() {
	...
	describe('The menu', function() {
		...
		it('The menu element has to be hidden by default', function() {
	...
	describe('New Feed Selection', function() {
		...
		beforeEach(function(done) {
			loadFeed(0, function() {
				firstContent = document.querySelector('.header-title').textContent;

				loadFeed(1, function() {
					secondContent = document.querySelector('.header-title').textContent;
					done();
				});
			});
		});

		it('The content should be different when we load twice', function() {
